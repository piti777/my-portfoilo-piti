...
const Work=(isDarkMode) => {
  return (
    ...
    id='work' className="w-full px-[12%] px-[12%] py-10 scroll-mt-20">
      ...
      className="text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo">
        I`m a frontend developer from Thailand, Chiang Mai, with limited
        ...
        {workData.map((project, index)=>(
            ...
            style={{backgroundImage: `url(${project.bgImage})`}}>
                ...
                justify-between duration-500 group-hover:bottom-7'>
                 ...
                 aspect-square flex items-center justify-center shadow-[_2px_0_#000] group-hover:bg-lime-300 transition'>
